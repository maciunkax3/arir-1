    ...
    class UsageSamples {
        ...
        static void Main() {
          ...
          //  SimulatorGui.Run(ListRanking.ListRankingSetup.Setup(10));
            ...
            SimulatorGui.Run(MatrixMultiplicationUsingMatrixDataType.MatrixMultiplicationUsingMatrixDataTypeSetup.Setup(16));
            //SimulatorGui.Run(Find3OnesInMatrix.Find3OnesInMatrixSetup.Setup(8));
        }
    }
}
